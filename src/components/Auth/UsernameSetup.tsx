...
export const UsernameSetup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const profile = await AuthService.createOrUpdateProfile(user.id, username.trim())
      setUser(profile)
    } catch (error) {
  ...
  return (
    <div className="card max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">This will be displayed to other players during battles</p>
      </div>
